...
console.log(containsW("Hello World"));
console.log(containsW("OpenAI"));
...
console.log(containsWorld("Hello World"));
console.log(containsWorld("This is the world!"));
console.log(containsWorld("Hello"));
...
console.log(isCapitalized("Hello World! This Is a Test"));
...
console.log(citiesAtoJ(["Amsterdam", "Bangkok", "Chicago", "Dallas", "Jakarta", "Los Angeles", "Moscow"]));
