...
const originalPeople = ['John', 'Jane', 'Alice'];
const newPeople = addPeople(originalPeople);

console.log('New people Array', newPeople);
console.log('Original People Array', originalPeople);
...
const oldPeople = ['John', 'Jane', 'Alice'];
const originalStuff = {item1: 'book', item2: 'pen'};

const nextState = setState (oldPeople, originalStuff);

console.log('New State Object', nextState);
console.log('Original People Array', oldPeople);
console.log('Original Stuff Object', originalStuff);
...
const coolPeople = ['John', 'Jane', 'Alice'];
const coolStuff = {
  cars: ['Toyota', 'Honda'],
  toothbrush: 'frayed',
  toys: 5
...
const newStateObject = newState(coolPeople, coolStuff);

console.log('New State Object:', newStateObject);
console.log('Original People Array:', coolPeople);
console.log('Original Stuff Object:', coolStuff);
